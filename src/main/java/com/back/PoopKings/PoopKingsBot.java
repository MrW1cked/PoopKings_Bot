...
@Service
@Slf4j
public class PoopKingsBot extends TelegramLongPollingBot {

    private final PodiumRepository repository;

    @Autowired
    public PoopKingsBot(PodiumRepository repository) {
    ...
    public String getBotUsername() {
        ...
        return "PoopKings_bot";
    }

    @Override
    public String getBotToken() {
        // Return bot token from BotFather
        return "6442987532:AAHIwqCt699g5f-JQ5TCK2rsKYY7JjSbRtM";
    }
